...
四次执行使用同一个测试 APK，SHA-256 为
<code>3CBB45A6D4C415B07E651F691736E1BA55A2E08AF4391C77708979738D4EE2A2</code>。测试结束后，两台
真机和两台模拟器上临时安装的 provider 与 test package 均已卸载；没有覆盖预先存在的 provider。
