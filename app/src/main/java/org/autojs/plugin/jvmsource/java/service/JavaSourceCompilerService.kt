...
import org.autojs.plugin.jvmsource.java.SingleActiveSessionGate
    ...
    private val binder = object : IJvmSourceProvider.Stub() {
        ...
        override fun openSession(
            ...
            if (request == null || sourceFd == null || stdoutFd == null || stderrFd == null ||
                ...
                OwnedSessionDescriptors.closeIncoming(sourceFd, stdoutFd, stderrFd)
                throw IllegalArgumentException("Java source session arguments must not be null")
            }
            val decodedRequest = try {
                ...
                OwnedSessionDescriptors.closeIncoming(sourceFd, stdoutFd, stderrFd)
                throw IllegalArgumentException("Java source request metadata is invalid", error)
            }
