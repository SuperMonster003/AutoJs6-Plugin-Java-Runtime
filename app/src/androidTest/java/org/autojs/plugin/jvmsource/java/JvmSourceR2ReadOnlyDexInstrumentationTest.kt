...
import org.autojs.plugin.jvmsource.java.worker.FileReadOnlyDexWriteTarget
import org.autojs.plugin.jvmsource.java.worker.PrivateDexArtifactPublisher
import org.autojs.plugin.jvmsource.java.worker.ReadOnlyDexWritePolicy
...
class JvmSourceR2ReadOnlyDexInstrumentationTest {
    ...
    private fun buildRealDex(context: android.content.Context): ByteArray {
        ...
        return PrivateSessionWorkspace.create(context, "Main.java").use { workspace ->
            ...
            assertTrue("ECJ failed before readonly DEX production", ecj.succeeded)
